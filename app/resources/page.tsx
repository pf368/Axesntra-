...
const QUESTIONS = [
  { href: '/questions/what-is-a-csa-score', title: 'What Is a CSA Score?', excerpt: "The FMCSA metric that reflects a carrier's safety performance across seven behavior categories." },
  { href: '/questions/what-is-a-bad-csa-score', title: 'What Is a Bad CSA Score?', excerpt: 'How to interpret elevated scores and what thresholds tend to draw regulatory attention.' },
  { href: '/questions/how-do-you-check-if-a-carrier-is-safe', title: 'How Do You Check If a Carrier Is Safe?', excerpt: 'The data sources and review steps that give you a defensible answer to that question.' },
  { href: '/questions/what-does-a-conditional-safety-rating-mean', title: 'What Does a Conditional Safety Rating Mean?', excerpt: "What FMCSA's conditional rating signals and how to factor it into your decision." },
  { href: '/questions/what-does-inactive-authority-mean', title: 'What Does Inactive Authority Mean?', excerpt: 'When operating authority goes inactive and what that means for the carriers you work with.' },
];

const PLAYBOOKS = [
  { href: '/playbooks/carrier-vetting-checklist-for-brokers', title: 'Carrier Vetting Checklist for Brokers', excerpt: 'A step-by-step carrier review process designed for freight broker workflows.' },
  { href: '/playbooks/what-to-do-after-an-out-of-service-event', title: 'What to Do After an Out-of-Service Event', excerpt: 'A response guide for teams managing relationships with carriers that have recent OOS activity.' },
  { href: '/playbooks/how-to-build-a-carrier-watchlist-process', title: 'How to Build a Carrier Watchlist Process', excerpt: 'How to structure a carrier monitoring workflow that flags risk changes before they become incidents.' },
];

const COMMERCIAL = [
  { href: '/commercial/carrier-risk-monitoring-software', title: 'Carrier Risk Monitoring Software', excerpt: 'Continuous monitoring that surfaces changes in carrier risk profiles automatically.' },
  { href: '/commercial/broker-carrier-screening-software', title: 'Broker Carrier Screening Software', excerpt: 'Built for freight brokerages that need fast, consistent carrier review at scale.' },
  { href: '/commercial/carrier-screening-for-underwriters', title: 'Carrier Screening for Underwriters', excerpt: 'Structured data to support underwriting decisions on new and renewal accounts.' },
  { href: '/commercial/carrier-watchlist-alerts', title: 'Carrier Watchlist Alerts', excerpt: "Automated alerts when a monitored carrier's risk profile changes materially." },
];
